...
const TermsScreen = ({ navigation }: any) => {
  ...
  const fetchTermsAndConditions = async () => {
    try {
      ...
      const url = `https://${domain}/tmp/pg_tnc.html`;
        ...
        <html>
          ...
          <body>
            ...
            <div class="error">
              ...
              <p>We're unable to load the Terms & Conditions at the moment. This could be due to:</p>
              <ul>
      ...
      <View style={styles.webViewContainer}>
        ...
        <WebView
          ...
          onError={(syntheticEvent) => {
            ...
            setError('Failed to display Terms & Conditions. Please try again.');
          }}
        />
      </View>
    </SafeAreaView>
